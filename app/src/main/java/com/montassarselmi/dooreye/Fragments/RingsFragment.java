...
public class RingsFragment extends Fragment {
    ...
    private String TAG= "RingsFragment";
    private TextView txtNoRings;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtNoRings = (TextView) view.findViewById(R.id.txt_no_rings);
        txtNoRings.setVisibility(View.GONE);
    ...
    private void loadData() {
        mBoxHistory.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (mDataSet.size() > 0)
                    mRecyclerView.setVisibility(View.VISIBLE);
                else txtNoRings.setVisibility(View.VISIBLE);
            }
            @Override
