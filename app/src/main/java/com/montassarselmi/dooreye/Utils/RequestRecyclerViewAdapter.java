...
public class RequestRecyclerViewAdapter extends RecyclerSwipeAdapter<com.montassarselmi.dooreye.Utils.RequestRecyclerViewAdapter.SimpleViewHolder> {



        private Context mContext;
        private ArrayList<User> usersList;
        private static final String TAG = com.montassarselmi.dooreye.Utils.RequestRecyclerViewAdapter.class.getSimpleName();
    ...
    public RequestRecyclerViewAdapter(Context context, ArrayList<User> objects) {
        this.mContext = context;
        this.usersList = objects;
    }

    @Override
        public com.montassarselmi.dooreye.Utils.RequestRecyclerViewAdapter.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        mSharedPreferences = mContext.getApplicationContext().getSharedPreferences("MyPref", Context.MODE_PRIVATE);
        editor = mSharedPreferences.edit();
        mAuth = FirebaseAuth.getInstance();
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_request_recyclerview, parent, false);
        return new SimpleViewHolder(view);
        }

        @Override
        public void onBindViewHolder(final com.montassarselmi.dooreye.Utils.RequestRecyclerViewAdapter.SimpleViewHolder simpleViewHolder, final int i) {
            ...
            //drag from the left
            simpleViewHolder.swipeLayout.addDrag(SwipeLayout.DragEdge.Left,simpleViewHolder.swipeLayout.findViewById(R.id.bottom_wrapper));
            // Drag From Right
            simpleViewHolder.swipeLayout.addDrag(SwipeLayout.DragEdge.Right, simpleViewHolder.swipeLayout.findViewById(R.id.bottom_wrapper1));
            ...
            simpleViewHolder.tvAccept.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(final View view) {
                    mRefUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            }else Toast.makeText(mContext, mContext.getResources().getText(R.string.you_cant_accept), Toast.LENGTH_SHORT).show();
            ...
            simpleViewHolder.tvRefuse.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    mRefUser.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                mUserQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                            ...
                                            notifyItemRangeChanged(i, usersList.size());
                                            mItemManger.closeAllItems();
                                            Toast.makeText(mContext, "Refused " + simpleViewHolder.txtUserName.getText().toString(), Toast.LENGTH_SHORT).show();
                            ...
                            }else Toast.makeText(mContext, mContext.getResources().getText(R.string.you_cant_refuse), Toast.LENGTH_SHORT).show();
        ...
        public static class SimpleViewHolder extends RecyclerView.ViewHolder {
            ...
            public SimpleViewHolder(View itemView) {
                ...
                tvRefuse = (TextView) itemView.findViewById(R.id.tvRefuse);
                tvEdit = (TextView) itemView.findViewById(R.id.tvModif);
